<template>
	...
	>
		...
		>
			<h2>안녕하세요.</h2>
			<div
				class="sticky-element a"
				ref="message1"
			>
				<p>프론트엔드 개발자<br />황지영입니다.</p>
			</div>
			<div
				class="sticky-element b"
				ref="message2"
			>
				<p>
					이 사이트는 포트폴리오 사이트입니다.<br />디자인부터 DB까지
					모든 것을 작업했습니다.
				</p>
			</div>
			<div
				class="sticky-element c"
				ref="message3"
			>
				<p>
					매일 리팩토링 작업 중입니다.<br />부족하지만 재밌게
					봐주세요.
				</p>
			</div>
			<div
				class="sticky-element d"
				ref="message4"
			>
				<p>행복하세요.&#x1F970;</p>
				<span class="img-area">
...
export default defineComponent({
	...
	setup() {
		...
		onMounted(() => {
			// cookie
			const currentCookie = getCookieValue('vueExpires');
